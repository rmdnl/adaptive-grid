...
def build_geometric_grid(lower, upper, step_pct, min_cells=1, max_levels=200):
...
def validate_grid_profit(levels: Iterable[GridLevel], buy_fee, sell_fee, roundtrip_slippage, hard_min):
